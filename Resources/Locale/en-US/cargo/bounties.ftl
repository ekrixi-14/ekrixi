...
bounty-description-artifact = The station is in some hot water for stealing artifacts from non-spacefaring planets. Return one and we'll compensate you for it.
...
bounty-description-donut = CoreGov scout security forces are facing heavy losses against the IncSek. Ship donuts to raise morale.
...
bounty-description-knife = One of our top commanders recently won a brand new set of knives on an official trade station gameshow. Unforunately, we don't have a set on hand. Send us a bunch of sharp things so we can throw something together,
...
bounty-description-mouse = We ran out of freeze-dried mice. Ship some fresh ones so their janitor doesn't go on strike.
bounty-description-pancake = Here at the trade station we consider employees to be family. And you know what families love? Pancakes. Ship a baker's dozen.
...
bounty-description-soup = To quell the homeless uprising, the trade station will be serving soup to all underpaid workers. Ship any type of soup.
